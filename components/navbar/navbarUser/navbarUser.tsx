...
import { UserIcon, WalletIcon, SettingsIcon, DollarSign } from 'lucide-react'
            ...
            {status
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        ...
                        <DropdownMenuItem><UserIcon className="h-4 w-4 mr-1" />Profile</DropdownMenuItem>
                        <DropdownMenuItem disabled><WalletIcon className="h-4 w-4 mr-1" />Billing</DropdownMenuItem>
                        <DropdownMenuItem><SettingsIcon className="h-4 w-4 mr-1" />Settings</DropdownMenuItem>
